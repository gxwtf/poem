...
export function Char({
    ...
    useEffect(() => {
        ...
        else if (!isNaN(memorize) && memorize > 0)setMemorizeMode(Math.random() < memorize ? CharMode.Memorize : CharMode.Read);
        else setMemorizeMode(CharMode.Read);
    }, [memorize, data.char, isFirstChar]);
